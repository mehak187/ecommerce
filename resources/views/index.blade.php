...
<body>
	...
	<!-------categories-sec--------->
	<section id="categories" class="product-section pt-150 mb-150" style="background:beige">
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-4 col-md-6 text-center">
					<div class="single-product-item">
						<div class="product-image">
							<a href="single-product.html"><img src="<?php echo asset('myimgs/' .$myCategory['photo']) ?>" alt=""></a>
						</div>
						<h3>{{$myCategory['name']}}</h3>
						<a href="products/{{$myCategory['id']}}" class="cart-btn">View Products</a>
					</div>
				</div>
				@endforeach
